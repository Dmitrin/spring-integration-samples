package integration.exceptiondemo.async.pollableErrorChannel;
...
import integration.exceptiondemo.configuration.async.pollableErrorChannel.AsyncServiceActivatorPollableChannelSIConfiguration;

import java.util.concurrent.Future;

@RunWith(SpringRunner.class)
@SpringBootTest
@ContextConfiguration(classes = {SIConfiguration.class, AsyncServiceActivatorPollableChannelSIConfiguration.class})
public class AsyncServiceActivatorPollableChannelSITests {
